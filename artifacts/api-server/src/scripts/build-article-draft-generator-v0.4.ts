...
const output = {
  package_version: "article-draft-generator-v0.4",
...
const jsonPath = path.join(outDir, "article-draft-generator-v0.4.json");
const mdPath = path.join(outDir, "sg-energy-trading-hub-draft-v0.4.md");
